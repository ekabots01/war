...
aditmadzs = LineClient(authToken='ELU1xDSttGs3xrhNPLUd./j5YLY1L6DO2457KzhIaBq.LA0vycRq/6zDAj+VX76mOPVIqW7xNZs0Tyw4v0Ml5IM=')
...
call = aditmadzs
creator = ["ub0aae6f44227d5597cd0e3013639ccde"]
owner = ["ub0aae6f44227d5597cd0e3013639ccde"]
admin = ["ub0aae6f44227d5597cd0e3013639ccde"]
staff = ["ub0aae6f44227d5597cd0e3013639ccde"]
...
def sendMention(to, mid, firstmessage):
    try:
        ...
        bot = runtime(eltime)
        text += mention+"»» Jam : "+datetime.strftime(timeNow,'%H:%M:%S')+" Wib\n🌟 Group : "+str(len(gid))+"\n»» Teman : "+str(len(teman))+"\n»» Version : http://github.com/ganabar\n»» Tanggal : "+datetime.strftime(timeNow,'%Y-%m-%d')+"\n»» Runtime : \n»» • "+bot
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               url = 'https://line.me/ti/p/~ekafiutama'
                        ...
                        if cmd == "unsend off":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "「 EKA BOTS BOT 」\n")
...
#===========Protection============#                                    
                        ...
                        elif 'Ekapro ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Ekapro ','')
                              if spl == 'on':
                                  if msg.to in protectqr:
                                       msgs = ""
                                  else:
...
#===========ADMIN ADD============#
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                aditmadzs.sendMessage(msg.to,"Ganabar bots  Done!")
                          ...
                          if wait["selfbot"] == True:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     aditmadzs.sendMessage(msg.to, "EKA FIUTAMA OTW JOIN GROUP : %s" % str(group.name))
                                     group1 = ki.findGroupByTicket(ticket_id)
                                     ki.acceptGroupInvitationByTicket(group1.id,ticket_id)
                                     ki.sendMessage(msg.to, "EKA FIUTAMA OTW JOIN GROUP : %s" % str(group.name))
                                     group2 = kk.findGroupByTicket(ticket_id)
                                     kk.acceptGroupInvitationByTicket(group2.id,ticket_id)
                                     kk.sendMessage(msg.to, "EKA FIUTAMA OTW JOIN GROUP : %s" % str(group.name))
                                     group3 = kc.findGroupByTicket(ticket_id)
                                     kc.acceptGroupInvitationByTicket(group3.id,ticket_id)
                                     kc.sendMessage(msg.to, "EKA FIUTAMA OTW JOIN GROUP : %s" % str(group.name))
